        ...
        <Row className="justify-between">
          ...
          <Column md={4} xl={3}>
            <div className="flex flex-col gap-4 leading-tight">
              ...
              {project.url && (
                <a className="group inline-flex items-center gap-2" href={project.url} target="_blank" rel="noopener noreferrer">
                  <span className="font-[450] text-gray-400">View Live</span>
                  <svg className="transition group-hover:translate-x-2" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
